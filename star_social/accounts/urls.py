...
urlpatterns = [
    ...
    path('logout/', auth_views.LogoutView.as_view(template_name='accounts/logout.html'), name='logout'), #The template_name provided here is the html to be displayed after logout has occurred
